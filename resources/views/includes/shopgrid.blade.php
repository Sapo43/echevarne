...
<div class="row mtn-30">
            ...
            @endif
                                    ...
                                    <div class="product-item__content">
                                       ...
                                       <h5 class=""><strong> <a href="#" data-toggle="modal" data-id="{{$producto->slug}}" onclick='loadModal(this)' data-target="#basicModal" style='color:black' > {{$producto->nombre}}</strong> - 
{{$producto->marca->nombre}}</a></h5>                                         
                                         
                                    
                                            <span><strong>Codigo : </strong><a href="#" data-toggle="modal" data-id="{{$producto->slug}}" onclick='loadModal(this)' data-target="#basicModal"  style='color:black'>{{$producto->codigo}}</a></span>
                                            @if(\Auth::check())
