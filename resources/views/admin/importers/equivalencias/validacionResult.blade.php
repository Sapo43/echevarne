        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-danger" role="alert">
                    ...
                    Se encontraron <strong>{{count($rowsError)}}</strong> errores en el archivo de Equivalencias
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-success" role="alert">
                    ...
                    Se van a importar <strong>{{count($rowsOk)}}</strong> Equivalencias.
                </div>                    
            </div>
        </div>        
        @endif           
