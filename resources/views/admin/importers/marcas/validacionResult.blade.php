    ...
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-danger" role="alert">
                    ...
                    Se encontraron <strong>{{count($rowsError)}}</strong> errores en el archivo de Marcas
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-success" role="alert">
                    ...
                    Se van a importar <strong>{{count($rowsOk)}}</strong> Marcas.
                </div>                    
            </div>
        </div>        
        @endif           
        <div class="row">
            <div class="col-md-12 text-right">
                {!! Form::open(['action' => 'App\Http\Controllers\Admin\Importers\ImporterMarcasController@importar', 'method' => 'POST', 'enctype' => 'multipart/form-data'])!!}
