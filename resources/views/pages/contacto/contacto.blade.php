   ...
   <div class="page-content-wrapper sm-top">
        <div class="contact-page-content">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="contact-info-item">
                                ...
                                <div class="con-info-txt">
                                    <h4>¿Dónde estamos?</h4>
                                    <p>Primera Junta 104 - Junín, Buenos Aires</p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <form action="//whizthemes.com/mail-php/raju/gariongso/mail.php" method="post" id="contact-form">
                                        <div class="contact-form-inner">
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="input-item">
                                                        <label class="sr-only" for="subject">asuntoes</label>
                                                ...
                                                <div class="col-12">
                                                    <div class="input-item">
                                                        ...
                                                        <textarea name="message" id="message" cols="30" rows="8" placeholder="Dejanos tu mensaje" required></textarea>
                                                    </div>
                                                </div>
            ...
            <div class="contact-map-wrapper sm-top">
                <div id="map_content" class="h-100" data-lat="-34.5862712" data-lng="-60.9336682" data-zoom="8"></div>
            </div>
        </div>
    </div>
