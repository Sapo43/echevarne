@if($producto->imagen != '')
    ...
    <figure class="pro-thumb-item" data-mfp-src="/img/productos/{{$producto->imagen}}.jpg">
        {{ HTML::image('/img/productos/'.$producto->imagen, $producto->nombre, array('class'=>'thumb-secondary ', 'title'=>$producto->nombre)) }}
        </figure>
    @else
    <figure class="pro-thumb-item" data-mfp-src="/img/productos/sin-imagen.png">
        {{ HTML::image('/img/productos/sin-imagen.png', $producto->nombre, array('class'=>'thumb-secondary ', 'title'=>$producto->nombre)) }}
        </figure>
    @endif
@else
    @if(isset($codProd))
    ...
    <figure class="pro-thumb-item" data-mfp-src="/img/productos/{{$codProd}}.jpg">
        {{ HTML::image('/img/productos/'.$codProd.'.jpg', $producto->nombre, array('class'=>'thumb-secondary ', 'title'=>$producto->nombre)) }}
        </figure>
    ...
    <figure class="pro-thumb-item" data-mfp-src="/img/productos/{{$codProd}}.png">
        {{ HTML::image('/img/productos/'.$codProd.'.png', $producto->nombre, array('class'=>'thumb-secondary ', 'title'=>$producto->nombre)) }}
        </figure>
    @elseif(file_exists(public_path().'/img/productos/'.$codProd.'.PNG'))
    <figure class="pro-thumb-item" data-mfp-src="/img/productos/{{$codProd}}.PNG">
        {{ HTML::image('/img/productos/'.$codProd.'.PNG', $producto->nombre, array('class'=>'thumb-secondary ', 'title'=>$producto->nombre)) }}
    ...
    <figure class="pro-thumb-item" data-mfp-src="/img/productos/{{$producto->codigo}}.jpg">
        {{ HTML::image('/img/productos/'.$producto->codigo.'.jpg', $producto->nombre, array('class'=>'thumb-secondary ', 'title'=>$producto->nombre)) }}
        </figure>
    ...
    <figure class="pro-thumb-item" data-mfp-src="/img/productos/{{$producto->codigo}}.png">
        {{ HTML::image('/img/productos/'.$producto->codigo.'.png', $producto->nombre, array('class'=>'thumb-secondary ', 'title'=>$producto->nombre)) }}
        </figure>
    @elseif(file_exists(public_path().'/img/productos/'.$producto->codigo.'.PNG'))
    <figure class="pro-thumb-item" data-mfp-src="/img/productos/{{$producto->codigo}}.PNG">
        {{ HTML::image('/img/productos/'.$producto->codigo.'.PNG', $producto->nombre, array('class'=>'thumb-secondary ', 'title'=>$producto->nombre)) }}
